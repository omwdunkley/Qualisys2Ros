...
void NBC_CMarkup::SetIndent( int nIndent )
{
    mnIndent = nIndent;
}

void NBC_CMarkup::operator=( const NBC_CMarkup& markup )
{
...
bool NBC_CMarkup::SetDoc( LPCTSTR szDoc )
{
	// Reset indexes
	m_iPosFree = 1;
	ResetPos();
	...
	unsigned int nStartSize = m_csDoc.GetLength() / 64 + 8;
...
bool NBC_CMarkup::FindElem( LPCTSTR szName )
{
...
bool NBC_CMarkup::FindChildElem( LPCTSTR szName )
{
...
CStdStringA NBC_CMarkup::GetTagName() const
{
	// Return the tag name at the current main position
	CStdStringA csTagName;
...
int NBC_CMarkup::x_ParseError( LPCTSTR szError, LPCTSTR szName )
{
	if ( szName )
...
int NBC_CMarkup::x_ParseElem( int iPosParent )
{
...
bool NBC_CMarkup::x_FindChar( LPCTSTR szDoc, int& nChar, _TCHAR c )
{
	// static function
...
bool NBC_CMarkup::x_FindAny( LPCTSTR szDoc, int& nChar )
{
...
bool NBC_CMarkup::x_FindToken( NBC_CMarkup::TokenPos& token )
{
...
CStdStringA NBC_CMarkup::x_GetToken( const NBC_CMarkup::TokenPos& token ) const
{
...
int NBC_CMarkup::x_FindElem( int iPosParent, int iPos, LPCTSTR szPath )
{
...
int NBC_CMarkup::x_ParseNode( NBC_CMarkup::TokenPos& token )
{
...
CStdStringA NBC_CMarkup::x_GetTagName( int iPos ) const
{
...
bool NBC_CMarkup::x_FindAttrib( NBC_CMarkup::TokenPos& token, LPCTSTR szAttrib ) const
{
...
CStdStringA NBC_CMarkup::x_GetAttrib( int iPos, LPCTSTR szAttrib ) const
{
...
bool NBC_CMarkup::x_SetAttrib( int iPos, LPCTSTR szAttrib, LPCTSTR szValue )
{
...
CStdStringA NBC_CMarkup::x_GetData( int iPos ) const
{
...
CStdStringA NBC_CMarkup::x_TextToDoc( LPCTSTR szText, bool bAttrib ) const
{
...
CStdStringA NBC_CMarkup::x_TextFromDoc( int nLeft, int nRight ) const
{
...
void NBC_CMarkup::x_DocChange( int nLeft, int nReplace, const CStdStringA& csInsert )
{
...
void NBC_CMarkup::x_Adjust( int iPos, int nShift, bool bAfterPos )
{
...
void NBC_CMarkup::x_LocateNew( int iPosParent, int& iPosRel, int& nOffset, int nLength, int nFlags )
{
...
bool NBC_CMarkup::x_AddElem( LPCTSTR szName, LPCTSTR szValue, bool bInsert, bool bAddChild )
{
	if ( bAddChild )
	{
    ...
    {
        bool bBacked = false;
        if ((nOffset < m_csDoc.GetLength()) && (0 < nOffset) && 
            (' ' == m_csDoc[nOffset-1]))
        {
	...
	{
		// <NAME>value</NAME>
		CStdStringA csValue = x_TextToDoc( szValue );
	...
	if ( bEmptyParent )
	{
		CStdStringA csParentTagName = x_GetTagName(iPosParent);
		CStdStringA csFormat;
		csFormat = _T(">\r\n");
		csFormat += csInsert;
