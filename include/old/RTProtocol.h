...
//Definition opf the save String compare, copy etc functions for UNICODE and not Unicode
#ifdef UNICODE 
...
private:
    ...
    void AddXMLElementBool(NBC_CMarkup* oXML, _TCHAR* tTag, const bool* pbValue,
                           _TCHAR* tTrue = ("True"), _TCHAR* tFalse = ("False"));
    void AddXMLElementBool(NBC_CMarkup* oXML, _TCHAR* tTag, const bool bValue,
                           _TCHAR* tTrue = ("True"), _TCHAR* tFalse = ("False"));
    void AddXMLElementInt(NBC_CMarkup* oXML, _TCHAR* tTag, const int* pnValue);
    void AddXMLElementUnsignedInt(NBC_CMarkup* oXML, _TCHAR* tTag, const unsigned int* pnValue);
    void AddXMLElementFloat(NBC_CMarkup* oXML, _TCHAR* tTag, const float* pfValue, unsigned int pnDecimals = 6);
