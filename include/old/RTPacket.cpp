...
{
	//This made problems did'nt figured out yet why but no it works...
	//printf("in Getsize()\n");
	//printf("%s", mpData);
    if (mpData == NULL)
    {
...
//Here as well just a quick and dirty solution...but probs just the variable mbBigEndian wasn't that probably
